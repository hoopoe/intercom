...
empq.push({"freeform":"Какое событие прошедшего года, относящиеся к Вашей работе, является для Вас самым важным? ", "a": ""});
empq.push({"freeform":"Есть ли у Вас проблемы, связанные с текущими обязанностями? Какие?", "a": ""});
empq.push({"freeform":"Чему Вы хотели бы поучиться (посетить конференцию, семинар, тренинг, сертифицироваться, повысить квалификацию самостоятельно)?", "a": ""});
empq.push({"freeform":"Какие предложения по улучшению работы в компании Вы хотели бы предложить?", "a": ""});
empq.push({"freeform":"Какие факторы (три в порядке убывания значимости) наиболее часто вызывают у вас позитив/вдохновляют/помогают работе?", "a": ""});
empq.push({"freeform":"Какие факторы (три в порядке убывания значимости) наиболее часто раздражают/мешают работе? ", "a": ""});
